...
namespace tflite {
    namespace examples {
        namespace superresolution {
            ...
            Java_com_example_main_SR_SRUtil_superResolutionFromJNI(
            ...
            Java_com_example_main_SR_SRUtil_initWithByteBufferFromJNI(
            ...
            Java_com_example_main_SR_SRUtil_deinitFromJNI(
