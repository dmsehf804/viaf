...
public class pictureFolderAdapter extends RecyclerView.Adapter<pictureFolderAdapter.FolderHolder>{
    ...
    private ArrayList<com.lilterest.viaf.utils.imageFolder> folders;
     ...
     */
    public pictureFolderAdapter(ArrayList<com.lilterest.viaf.utils.imageFolder> folders, Context folderContx, itemClickListener listen) {
    ...
    public void onBindViewHolder(@NonNull FolderHolder holder, int position) {
        final com.lilterest.viaf.utils.imageFolder folder = folders.get(position);
